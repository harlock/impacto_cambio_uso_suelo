    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header bg-light border">
                <h5 class="modal-title text-dark text-uppercase text-bold-700" id="exampleModalCenterTitle">Nuevo Criterio</h5>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-icon btn-outline-success" @click="addCriterio" data-dismiss="modal">Agregar</button>
            </div>
        </div>
    </div>
</div>
