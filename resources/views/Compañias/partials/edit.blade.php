        ...
        <div class="modal-content">
            <div class="modal-body p-0">
                <div class="modal-header bg-light border">
                    <h4 class="modal-title text-dark text-uppercase text-bold-700" id="topModalLabel">Editar Compañía
                    </h4>
                ...
                <div class="row justify-content-center">
                    <div class="col-10">
                        <div class="form-group mb-3">
                            <label class="text-dark float-left h5" for="nameEdit">Compañía</label>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-icon btn-outline-success" data-dismiss="modal" @click="updateCompania">Aceptar</button>
            </div>
        </div>
    </div>
</div>
