        ...
        <div class="modal-content">
            <div class="modal-body p-0">
                <div class="modal-header bg-light border">
                    <h4 class="modal-title text-dark text-uppercase text-bold-700" id="topModalLabel">Editar Tipo de Proyecto
                    </h4>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-icon btn-outline-success" data-dismiss="modal" @click="updateTipo">Aceptar</button>
            </div>
        </div>
    </div>
</div>
