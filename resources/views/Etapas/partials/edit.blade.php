        ...
        <div class="modal-content">
            <div class="modal-body p-0">
                <div class="modal-header bg-light border">
                    <h4 class="modal-title text-dark text-bold-700 text-uppercase" id="topModalLabel">Editar Etapa
                    </h4>
                ...
                <div class="row justify-content-center">
                    <div class="col-10">
                        <div class="form-group mb-3">
                            <label class="text-dark float-left" for="nameEdit">Etapa*</label>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-icon btn-outline-success" data-dismiss="modal" @click="updateEtapa">Aceptar</button>
            </div>
        </div>
    </div>
</div>
